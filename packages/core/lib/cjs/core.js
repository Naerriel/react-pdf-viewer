...
var useAnimationFrame = function (callback, recurring, deps) {
    ...
    var idRef = React__namespace.useRef(-1);
    ...
    React__namespace.useEffect(function () { return function () { return stop(); }; }, []);
    return [start];
};
...
var useSafeState = function (initialState) {
    ...
    var setSafeState = React__namespace.useCallback(function (newState) {
...
var PageLayer = function (_a) {
    ...
    var renderPluginsLayer = function (plugins) {
        return plugins.map(function (plugin, idx) { return (React__namespace.createElement(React__namespace.Fragment, { key: idx },
...
var Inner = function (_a) {
    ...
    var forceTargetPageRef = React__namespace.useRef({
        targetPage: -1,
        zoomRatio: 1,
    });
    ...
    var _e = React__namespace.useState(false), areSizesCalculated = _e[0], setSizesCalculated = _e[1];
    var _f = React__namespace.useState(estimatedPageSizes), pageSizes = _f[0], setPageSizes = _f[1];
    var _g = React__namespace.useState(0), currentPage = _g[0], setCurrentPage = _g[1];
    var _h = React__namespace.useState(new Map()), pagesRotation = _h[0], setPagesRotation = _h[1];
    var _j = React__namespace.useState(initialRotation), rotation = _j[0], setRotation = _j[1];
    var _k = React__namespace.useState(initialScale), scale = _k[0], setScale = _k[1];
    var _l = React__namespace.useState(initialScrollMode), scrollMode = _l[0], setScrollMode = _l[1];
    var _m = React__namespace.useState(initialViewMode), viewMode = _m[0], setViewMode = _m[1];
    ...
    var switchScrollMode = React__namespace.useCallback(function (newScrollMode) {
        renderQueue.markNotRendered();
    ...
    var switchViewMode = React__namespace.useCallback(function (newViewMode) {
        renderQueue.markNotRendered();
    ...
    React__namespace.useEffect(function () {
        if (fullScreen.fullScreenMode === exports.FullScreenMode.Entered && keepSpecialZoomLevelRef.current) {
    ...
    var renderNextPageInQueue = useAnimationFrame(function () {
        if (stateRef.current.fullScreenMode === exports.FullScreenMode.Entering ||
            stateRef.current.fullScreenMode === exports.FullScreenMode.Exitting) {
            return;
        }
            ...
            subSlot: {
                attrs: {
                    ...
                    className: classNames({
                        ...
                        'rpv-core__inner-pages--horizontal': scrollMode === exports.ScrollMode.Horizontal,
                        'rpv-core__inner-pages--rtl': isRtl,
                        'rpv-core__inner-pages--single': scrollMode === exports.ScrollMode.Page,
                        'rpv-core__inner-pages--vertical': scrollMode === exports.ScrollMode.Vertical,
                        'rpv-core__inner-pages--wrapped': scrollMode === exports.ScrollMode.Wrapped,
                    }),
                    ref: pagesRef,
                    style: {
                        height: '100%',
                ...
                children: (React__namespace.createElement("div", { "data-testid": "core__inner-current-page-".concat(currentPage), style: Object.assign({
                        ...
                        'rpv-core__inner-page-container--single': scrollMode === exports.ScrollMode.Page,
                    ...
                    var isCover = viewMode === exports.ViewMode.DualPageWithCover &&
                    ...
                    return (React__namespace.createElement("div", { "aria-label": pageLabel.replace('{{pageIndex}}', "".concat(item.index + 1)), className: classNames({
                            ...
                            'rpv-core__inner-page--dual-even': viewMode === exports.ViewMode.DualPage && item.index % 2 === 0,
                            'rpv-core__inner-page--dual-odd': viewMode === exports.ViewMode.DualPage && item.index % 2 === 1,
                            'rpv-core__inner-page--dual-cover': isCover,
                            'rpv-core__inner-page--dual-cover-even': viewMode === exports.ViewMode.DualPageWithCover &&
                                !isCover &&
                                item.index % 2 === 0,
                            'rpv-core__inner-page--dual-cover-odd': viewMode === exports.ViewMode.DualPageWithCover &&
                                !isCover &&
                                item.index % 2 === 1,
                            'rpv-core__inner-page--single': viewMode === exports.ViewMode.SinglePage && scrollMode === exports.ScrollMode.Page,
...
var StackContext = React__namespace.createContext({
    currentIndex: 0,
...
var useTheme = function (theme) {
    var addStyles = React__namespace.useCallback(function () {
    ...
    var removeStyles = React__namespace.useCallback(function () {
...
var Viewer = function (_a) {
    ...
    var _w = React__namespace.useState(0), numStacks = _w[0], setNumStacks = _w[1];
    ...
    return (React__namespace.createElement(StackContext.Provider, { value: { currentIndex: 0, increaseNumStacks: increaseNumStacks, decreaseNumStacks: decreaseNumStacks, numStacks: numStacks } },
        React__namespace.createElement(LocalizationContext.Provider, { value: localizationContext },
            React__namespace.createElement(ThemeContext.Provider, { value: themeContext },
                React__namespace.createElement("div", { ref: containerRef, className: "rpv-core__viewer", "data-testid": "core__viewer", style: {
                        height: '100%',
                        width: '100%',
...
var Worker = function (_a) {
    ...
    return React__namespace.createElement(PdfJsApiContext.Provider, { value: { pdfJsApiProvider: apiProvider } }, children);
};
...
var useClickOutsideStack = function (closeOnClickOutside, onClickOutside) {
    var stackContext = React__namespace.useContext(StackContext);
    var _a = React__namespace.useState(), ele = _a[0], setEle = _a[1];
    var ref = React__namespace.useCallback(function (ele) {
        setEle(ele);
    }, []);
    var handleClickDocument = React__namespace.useCallback(function (e) {
...
var useEscapeStack = function (handler) {
    var stackContext = React__namespace.useContext(StackContext);
    var keyUpHandler = React__namespace.useCallback(function (e) {
...
var Stack = function (_a) {
    var children = _a.children;
    var _b = React__namespace.useContext(StackContext), currentIndex = _b.currentIndex, increaseNumStacks = _b.increaseNumStacks, decreaseNumStacks = _b.decreaseNumStacks, numStacks = _b.numStacks;
    React__namespace.useEffect(function () {
        increaseNumStacks();
        return function () {
            decreaseNumStacks();
    ...
    return ReactDOM__namespace.createPortal(React__namespace.createElement(StackContext.Provider, { value: {
...
var Modal = function (_a) {
    ...
    var renderContent = function (toggle) { return (React__namespace.createElement(ModalOverlay, null,
        React__namespace.createElement(ModalBody, { ariaControlsSuffix: controlsSuffix, closeOnClickOutside: closeOnClickOutside, closeOnEscape: closeOnEscape, onClose: toggle }, content(toggle)))); };
    return (React__namespace.createElement(React__namespace.Fragment, null,
        target && renderTarget(toggle, opened),
        opened && React__namespace.createElement(Stack, null, renderContent(toggle))));
};
...
var PopoverBody = React__namespace.forwardRef(function (props, ref) {
    ...
    return (React__namespace.createElement("div", { "aria-describedby": innerId, className: classNames({
...
var PopoverOverlay = function (_a) {
    ...
    return (React__namespace.createElement("div", { className: "rpv-core__popover-overlay", ref: containerRef }, children));
};

var AVAILABLE_POSITIONS = [
    exports.Position.TopLeft,
    exports.Position.TopCenter,
    exports.Position.TopRight,
    exports.Position.RightTop,
    exports.Position.RightCenter,
    exports.Position.RightBottom,
    exports.Position.BottomLeft,
    exports.Position.BottomCenter,
    exports.Position.BottomRight,
    exports.Position.LeftTop,
    exports.Position.LeftCenter,
    exports.Position.LeftBottom,
];
...
var Portal = function (_a) {
    ...
    var _c = React__namespace.useState(), ele = _c[0], setEle = _c[1];
    var _d = React__namespace.useState(position), updatedPosition = _d[0], setUpdatedPosition = _d[1];
    var targetRef = React__namespace.useCallback(function (ele) {
        setEle(ele);
    }, []);
    var prevBoundingRectsRef = React__namespace.useRef([]);
    ...
    return React__namespace.createElement(Stack, null, children({ position: updatedPosition, ref: targetRef }));
};
...
var Popover = function (_a) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        React__namespace.createElement("div", { ref: targetRef, "aria-expanded": opened ? 'true' : 'false', "aria-haspopup": ariaHasPopup, "aria-controls": "rpv-core__popver-body-".concat(controlsSuffix) }, target(toggle, opened)),
        opened && (React__namespace.createElement(Portal, { offset: 8, position: position, referenceRef: targetRef }, function (_a) {
            var updatedPosition = _a.position, ref = _a.ref;
            var popoverBody = (React__namespace.createElement(PopoverBody, { ariaControlsSuffix: controlsSuffix, closeOnClickOutside: closeOnClickOutside, position: updatedPosition, ref: ref, onClose: toggle }, content(toggle)));
            return lockScroll ? (React__namespace.createElement(PopoverOverlay, { closeOnEscape: closeOnEscape, onClose: toggle }, popoverBody)) : (popoverBody);
        }))));
};

var TooltipBody = React__namespace.forwardRef(function (props, ref) {
...
var Tooltip = function (_a) {
    ...
    return (React__namespace.createElement(React__namespace.Fragment, null,
        ...
        opened && (React__namespace.createElement(Portal, { offset: 8, position: position, referenceRef: targetRef }, function (_a) {
            var updatedPosition = _a.position, ref = _a.ref;
            return (React__namespace.createElement(TooltipBody, { ariaControlsSuffix: controlsSuffix, closeOnEscape: true, position: updatedPosition, ref: ref, onClose: close }, content()));
        }))));
};
